...
├── api/
│   ├── getSharedData.js        # Vercel Serverless Function：從 Vercel KV 讀取共享資料
│   └── saveSharedData.js       # Vercel Serverless Function：寫入共享資料到 Vercel KV
